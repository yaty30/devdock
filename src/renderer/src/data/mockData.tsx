...
export const buildStages: BuildStage[] = [
  { label: "Build started", time: "09:34:21 AM", state: "complete" },
  { label: "Clean project", time: "09:34:24 AM", state: "complete" },
  { label: "Backend compile", time: "09:34:48 AM", state: "complete" },
  { label: "Frontend build", time: "09:36:12 AM", state: "complete" },
  { label: "Package WAR", time: "09:37:05 AM", state: "complete" },
  { label: "Deploying", time: "09:40:10 AM", state: "complete" },
  { label: "Completed", time: "09:41:03 AM", state: "current" },
];
